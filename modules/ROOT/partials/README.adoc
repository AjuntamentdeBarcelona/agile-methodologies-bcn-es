...
:uri-public-repo: https://github.com/AjuntamentdeBarcelona/agile-methodologies-bcn-es
//
// MANDATORY. Exactly the same value you give to key "name" in file antora.yml.
:component-name: es/agile-methodologies
//
// MANDATORY. Title of the document. In web format, it appears as a heading of
// level 1. In PDF format, it appears in a title page.
:_title: Metodologías Agile en el Ayuntamiento de Barcelona
//
...
:_summary: Principios y prácticas de transformación “Agile” del Ayuntamiento de Barcelona en materia de tecnología e innovación
//
// MANDATORY. Comma-separated list of terms to help classifying and searching
// the document. In web format, this terms are integrated as SEO enabling
// metadata. In PDF format, they are shown near the other metadata.
:keywords: estandares digitales éticos, derechos digitales, ayuntamiento de barcelona, metodologías agile
//
